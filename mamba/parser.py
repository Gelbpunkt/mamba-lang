...
def p_array_access(p):
    """
    expression : indexable LSQBRACK expression RSQBRACK
    """
...
def p_slice(p):
    """
    expression : indexable LSQBRACK expression COLON expression RSQBRACK
               | indexable LSQBRACK COLON expression RSQBRACK
               | indexable LSQBRACK expression COLON RSQBRACK
               | indexable LSQBRACK COLON RSQBRACK
    """
    if len(p) == 7:
...
def p_array_access_assign(p):
    """
    statement : indexable LSQBRACK expression RSQBRACK EQUALS expression STMT_END
    """
